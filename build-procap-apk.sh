...
cp "$ROOT_DIR/icon-procap-192.png" "$WEB_DIR/"
cp "$ROOT_DIR/icon-procap-512.png" "$WEB_DIR/"
cp "$ROOT_DIR/bienvenue-lesson.jpg" "$WEB_DIR/"
cp "$ROOT_DIR/whatsapp-icon.png" "$WEB_DIR/"
cp "$ROOT_DIR/sw-procap.js" "$WEB_DIR/"
...
ICON_SRC="$ROOT_DIR/icon-procap-512.png"
